...
def modul_2():
    ...
    def setengah_interval(X1,X2):
        print(" =========================================================\n",
              ...
              "Hand-crafted & Made by Kelompok 5 \n",
              "Kelas: Oseanografi B \n",
              "=========================================================\n")
        X1 = X1
        X2 = X2
...
def modul_4():
    ...
    def trapesium_1pias():
        ...
        plt.savefig('C:/Users/TRITON 300/OneDrive/Documents/Tugas Akhir Praktikum Metnum 2021/image/Trapesium 1 Pias.png')
        L = 0.5*(fx2 + fx1)*(x2 - x1)
    ...
    plt.savefig('C:/Users/TRITON 300/OneDrive/Documents/Tugas Akhir Praktikum Metnum 2021/image/Trapesium Banyak Pias.png')
    #Metode Simpson 1/3
...
def modul_5():
    ...
    def euler():
        ...
        plt.savefig('C:/Users/TRITON 300/OneDrive/Documents/Tugas Akhir Praktikum Metnum 2021/image/Euler.png')
    # Metode Heun
    def heun():
        Nama = (input("Masukkan Nama: "))
        Nim = (input("Masukkan NIM: "))
        ...
        plt.grid() #u/ menampilkan grid
        plt.legend(loc='lower right')
        plt.savefig('C:/Users/TRITON 300/OneDrive/Documents/Tugas Akhir Praktikum Metnum 2021/image/Heun.png')
